...
document.addEventListener('DOMContentLoaded', function () {
  console.log("Dashboard JS is loaded and firing!");
  ...
  document.querySelectorAll('.js-refresh').forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      // Reload page to pull fresh data
  ...
  document.querySelectorAll('.js-export').forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      list.querySelectorAll('.activity-item').forEach(function (item) {
        ...
        // action text is the plain text between the two strongs
        const actionRaw = text ? text.textContent.replace(actor, '').replace(itemLabel, '').trim() : '';
